                ...
                <div class="col-12">
                    <div class="pt-20">
                        <v-multi-search-panel
                            v-model="$filters('bookings-rostered').data"
            ...
            <div class="col-xl-6 d-none d-xl-flex u-border-left">
                <div class="c-aside-icon">
                    <div class="c-aside-icon__inner">
                        ...
                        <div class="title">{{ $t('Rostered') }}</div>
                    </div>
                </div>
            </div>
        </template>
...
import breadcrumbs from '../breadcrumbs/rostered';
...
export default {
    ...
    computed: {
        breadcrumbs: breadcrumbs.make('rostered.list'),
        ...mapStatuses([
            {
                name: 'list.fetch',
    ...
    methods: {
        ...
        ...mapActions('bookings', {
            async list(dispatch) {
                const data = await dispatch('listRostered');
