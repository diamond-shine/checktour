    ...
    <main class="c-fullpage">
        <div class="c-fullpage__inner">
            <div class="c-login">
                ...
                @if (session('status'))
                    <div role="alert" class="c-login__heading el-alert el-alert--success">
                        <div class="el-alert__content">
                            <span class="el-alert__title">{{ session('status') }}</span>
                        </div>
                    </div>
                @endif

                <div class="c-login__main">
                    {{ Form::open(['route' => 'control.auth.password.email']) }}
                        <div class="el-form-item {{ $errors->has('email') ? 'is-error' : '' }}">
                            <div class="el-input el-input--prefix">
                                {{ Form::email('email', null, ['class' => 'el-input__inner', 'placeholder' => _('Enter E-mail')]) }}
                ...
                <div class="c-login__footer">
                    {{ _('Remember your password?') }} <a href="{{ route('control.auth.login') }}">
                        {{ _('Enter') }}
                    </a>
                </div>
            </div>
